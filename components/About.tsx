...
function About({}: Props) {
  return (
    <motion.div
      ...
      className="h-screen flex flex-col relative text-center md:text-left md:flex-row max-w-7xl px-5 md:px-10 justify-evenly mx-auto items-center"
    >
      ...
      <motion.div
        ...
        whileInView={{ x: 0 }}
        transition={{ duration: 1.5 }}
        className="px-0 pb-28 md:mb-8 md:px-10 space-y-1 md:space-y-6"
      >
