      ...
      <div className="flex flex-col space-y-10">
        ...
        <div className="space-y-10">
          <div className="flex items-center space-x-5 justify-center">
            ...
            <a href="tel:+33 6 50 67 16 33" className="text-2xl">
              06 50 67 16 33
            </a>
          </div>
          ...
          <div className="flex items-center space-x-5 justify-center">
            ...
            <p className="text-2xl">aniq.filali.mehdi@gmail.com</p>
          </div>

          <div className="flex items-center space-x-5 justify-center">
            <MapIcon className="text-[#F7AB0A] h-7 w-7 animate-pulse" />
            <p className="text-2xl">1 Square Charles Baudelaire, Evry</p>
          </div>
        </div>
